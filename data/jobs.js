    ...
    progressions: [
      {
        ...
        description: "Joined Nike as a Product Owner on the Search team, responsible for Nike's legacy search platform built on Endeca technology. Created new search indexes and developed search strategies to improve product discoverability across Nike's digital properties. Onboarded new geographic markets onto the search platform, ensuring each geo's product catalog was correctly indexed and surfaced to consumers. Worked closely with engineering and geo teams to tune search relevance and expand platform coverage. Additionally owned Nike's relationship with Certona, the recommendation engine powering product recommendations across Nike's product wall and product detail pages. While the front-end team owned the recommendation widget itself, ownership of the back-end API meant defining what products were shown, why they were shown, and the testing strategy behind it. Managed A/B tests to validate different recommendation methods and engines, and developed vendor management skills, including how to evaluate, negotiate with, and hold accountable a third-party recommendation provider.",
      ...
      },
      {
        ...
        description: "Primary PM for Nike's Digital Promotions platform. Built a new Digital Promotions Management Tool from its first prototype to the globally deployed system of record used across every Nike geo. Allowing Digital Experiences teams to better run promotion campaigns leading to an elevation of consumer engagement, UPT, and checkout success rates. Iteratively added support for new promotion strategies determined by Digital Experiences team feedback along with customer engagement. Expanded scope to include a multi-phase Promotion Data Emission framework to allow for more automation and better customer matching, a security model overhaul, and an intern-led UI refresh proposal validated by Nike's design team. Concluded with a structured 3-session knowledge transfer series in December 2023, fully onboarding the incoming team with all PRDs, roadmaps, and future plans documented. Also mentored a summer PM intern through Nike's internship program, tasked with identifying project opportunities, coaching the intern from problem definition through stakeholder alignment, feasibility assessment, and final presentation to Nike leadership. The intern was recognized as one of the top three presenters in the summer cohort and was offered a full-time position the following year. As part of the Checkouts team org at Nike, developed deep expertise in the end-to-end checkout flow across Nike.com and the Nike App, understanding inventory availability, shipping options, and the precise moment in the checkout process where digital promotions were evaluated and applied. This cross-domain visibility meant working intimately with the Checkouts team to ensure promotion logic integrated seamlessly into the customer experience without disrupting conversion.",
